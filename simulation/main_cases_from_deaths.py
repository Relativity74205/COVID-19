...
def calculate_case_ci(deaths: int, p_min: float, p_max: float, n: int) \
        -> Tuple[int, int]:
    try:
...
s_cases_ci = df_germany.apply(lambda row: calculate_case_ci(row.deaths, 0.003, 0.01, 10000), axis=1)
#%%

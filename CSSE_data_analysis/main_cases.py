...
value_name = 'cases'
df_cases_tidy_filtered = mf.get_csse_data(value_name, min_cases=20, rolling_window=3)
...
subfig1 = px.line(df_cases_tidy_filtered, x='date', y=value_name, color='country')
